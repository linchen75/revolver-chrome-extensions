...
var openAllMonitoringPage = function () {
  var urlList = ["https://careerbuilder.splunkcloud.com/en-US/app/search/slis?form.time_range.earliest=-24h%40h&form.time_range.latest=now",
    "https://jenkins.cbapac.net/",
    "https://rpm.newrelic.com/accounts/1326581/applications/39606908"
    ];
  urlList.forEach(function (url) {
    ...
    // setTimeout(function(){
    //   jQuery("body").prepend("<div style='position: absolute; top: 0; width: 100%; background: #000; color: #fff; height: 30px; line-height: 30px; '><h1>Monitor</h1></h1></div>");
    // },5000);
